...
export class SneltoetsAcceptatie {
  ...
  constructor(page: Page) {
    ...
    this.inputBrutoJaarinkomenError = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView2')
      .getByText('Ongeldige waarde');
    ...
    this.dateMedeaanvragerGeboortedatum = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView3')
      .getByRole('textbox', { name: 'Geboortedatum' });
    this.inputMedeaanvragerBrutoJaarinkomen = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView3')
      .getByRole('textbox', { name: 'Bruto jaarinkomen' });
    this.inputMedeaanvragerBrutoJaarinkomenError = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView3')
      .getByText('Ongeldige waarde');
    this.inputMedeaanvragerVerminderdInkomen = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView3')
      .getByRole('textbox', { name: 'Verminderd inkomen' });
    this.inputMedeaanvragerVanafMaand = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.dataView3')
      .getByRole('textbox', { name: 'Vanaf maand' });

    this.radiobuttonFinancieleVerplichtingen = page.getByRole('radiogroup', { name: 'Financiële verplichtingen?' });
    this.inputFinancieleVerplichtingenBedragMaandelijks = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.container19')
      .getByRole('textbox', { name: 'Bedrag maandelijks' });
    this.inputFinancieleVerplichtingenAantalMaanden = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.container19')
      .getByRole('textbox', { name: 'Aantal maanden' })
      .first();
    this.inputFinancieleVerplichtingenHoogteMaandelijkseAlimentatieplicht = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.container19')
      .getByRole('textbox', { name: 'Hoogte maandelijkse' });
    this.inputFinancieleVerplichtingenAantalMaandenAlimentatieplicht = page
      .getByTestId('391.InkomensToets.NhgInkToetsContent_201801.container19')
      .getByRole('textbox', { name: 'Aantal maanden' })
      .nth(1);
    ...
    this.valueDatumToetsing = page
      .locator('.mx-datepicker', {
        has: page.locator('label', { hasText: 'Datum toetsing' }),
      })
      .locator('.form-control-static');
    this.valueIndicatieLening = page
      .locator('.mx-textbox', {
  ...
  async fillSneltoetsForm(fields: SneltoetsFormFields) {
    ...
    if (fields.financieleVerplichtingen === 'Ja') {
      ...
      await this.inputFinancieleVerplichtingenBedragMaandelijks.fill(
        fields.financieleVerplichtingenBedragMaandelijks || '',
      );
      await this.inputFinancieleVerplichtingenAantalMaanden.fill(fields.financieleVerplichtingenAantalMaanden || '');
      await this.inputFinancieleVerplichtingenHoogteMaandelijkseAlimentatieplicht.fill(
        fields.financieleVerplichtingenHoogteMaandelijkseAlimentatieplicht || '',
      );
      await this.inputFinancieleVerplichtingenAantalMaandenAlimentatieplicht.fill(
        fields.financieleVerplichtingenAantalMaandenAlimentatieplicht || '',
      );
  ...
  async clickSneltoetsBerekenButton(): Promise<Response> {
    const responsePromise = this.page.waitForResponse((response) => response.url().includes('/xas/'));
